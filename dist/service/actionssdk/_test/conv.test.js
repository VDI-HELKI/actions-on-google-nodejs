...
ava_1.default('conv.data is parsed correctly', t => {
    const data = {
        a: '1',
        b: '2',
        c: {
...
ava_1.default('conv generates no conversationToken from empty conv.data', t => {
...
ava_1.default('conv generates first conv.data replaced correctly', t => {
    const response = `What's up?`;
    const data = {
        a: '1',
        b: '2',
...
ava_1.default('conv generates first conv.data mutated correctly', t => {
    const response = `What's up?`;
    const a = '7';
    const conv = new conv_1.ActionsSdkConversation();
    t.deepEqual(conv.data, {});
...
ava_1.default('conv generates different conv.data correctly', t => {
    const response = `What's up?`;
    const data = {
        a: '1',
        b: '2',
...
ava_1.default('conv generates different conv.data correctly when only with init data', t => {
    const response = `What's up?`;
    const data = {
        a: '1',
        b: '2',
...
ava_1.default('conv generates same conv.data persisted', t => {
    const response = `What's up?`;
    const data = {
        a: '1',
        b: '2',
...
ava_1.default('conv sends userStorage when it is not empty', t => {
    const response = `What's up?`;
    const data = {
        a: '1',
        b: '2',
...
ava_1.default('conv does not send userStorage when it is empty', t => {
    const response = `What's up?`;
    const conv = new conv_1.ActionsSdkConversation();
    t.deepEqual(conv.user.storage, {});
    conv.ask(response);
...
ava_1.default('conv sends correct ask response', t => {
    const response = `What's up?`;
    const conv = new conv_1.ActionsSdkConversation();
    conv.ask(response);
    t.deepEqual(common_1.clone(conv.serialize()), {
...
ava_1.default('conv sends correct close response', t => {
    const response = 'Bye';
    const conv = new conv_1.ActionsSdkConversation();
    conv.close(response);
    t.deepEqual(common_1.clone(conv.serialize()), {
...
ava_1.default('conv does not send inputPrompt when items are empty', t => {
    const conv = new conv_1.ActionsSdkConversation();
